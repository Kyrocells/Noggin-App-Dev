                    ...
                    if (count($videos) > 0) {
                        foreach ($videos as $video) {
                            ...
                            echo "<td class='actions'>
                                    <a href='index_admin.php?page=edit&id={$video['video_id']}' class='btn admin_button mx-2'>Edit</a>
                                    <a href='index_admin.php?page=delete&id={$video['video_id']}' class='btn admin_button mx-2'>Delete</a>
                                </td>";
                            echo "</tr>";
                        }
                    } else {

...
?>
        ...
        <form action="index_admin.php?page=edit&id=<?php echo $video['video_id']; ?>" method="post" enctype="multipart/form-data">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="card-footer">
                <a href="index_admin.php?page=delete&confirm=yes&id=<?= $videoId; ?>" class="btn admin_button mx-2">Delete</a>
                <a href="index_admin.php?page=view" class="btn admin_button mx-2">Cancel</a>
            </div>
        </div>
<?php
        ...
        header('Location: index_admin.php?page=view');
        exit();
    }
    ...
    header('Location: index_admin.php?page=view'); // Redirect to the video list page
    exit();
} else {
    // No ID was provided

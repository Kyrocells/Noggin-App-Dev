            ...
            <?php else: ?>
                <?php foreach ($returned_videos as $video): ?>
                    <div class="card movie_card">
                        ...
                        <div class="additional-content">
                            <a href="index_user.php?page=single_return&video_id=<?php echo $video['video_id']; ?>&video_format=<?php echo urlencode($video['video_format']); ?>" class="movie_card_button mb-2">View</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>

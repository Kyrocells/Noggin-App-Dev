    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasLabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="list-group my-4">
                <a href="index_user.php?page=rent" class="list-group-item list-group-item-action <?php echo $current_page == 'rent' ? 'active' : 'not_active'; ?>" aria-current="true">
                    Rent
                </a>
                <a href="index_user.php?page=rent_history" class="list-group-item list-group-item-action <?php echo $current_page == 'rent_history' ? 'active' : 'not_active'; ?>">Rent History</a>
                <a href="index_user.php?page=profile" class="list-group-item list-group-item-action <?php echo $current_page == 'profile' ? 'active' : 'not_active'; ?>">Profile</a>

        ...
        foreach ($movies_by_genre as $genre => $movies) {
            if (!empty($movies)) {
                ...
                foreach ($movies as $movie) {
                    ...
                    echo '<a href="index_user.php?page=single_view&video_id=' . $movie['video_id'] . '" class="movie_card_button mb-2">View</a>';
                    if ($movie['num_videos_available'] > 0) {
                        echo '<a href="index_user.php?page=rent_payment&video_id=' . $movie['video_id'] . '" class="movie_card_button">Rent</a>';
                    } else {

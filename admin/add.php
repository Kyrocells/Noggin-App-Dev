            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col">
                                <input type="number" class="form-control" name="hours" placeholder="Hours" required min="0" pattern="[0-9]">
                            </div>
                            <div class="col">
                                <input type="number" class="form-control" name="minutes" placeholder="Minutes" required min="0" >
                            </div>
                        </div>
                    </div>
